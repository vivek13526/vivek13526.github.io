...
vneed=Math.floor((cneed*0.25)/7);
if (wtype=="pounds")
{
vneed=Math.floor(vneed*0.0353);
}
...
document.getElementById("ra").value=" "+vneed;
...
document.getElementById("ra").value=" "+vita;
